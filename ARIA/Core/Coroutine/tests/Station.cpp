#include "ARIA/Coroutine/Station.h"
...
static Coroutine::station<MySpinLock> station;
static Coroutine::station<> stationNonThreadSafe;
...
cppcoro::task<> Func1() {
  ...
  // Wait until all the passengers having arrived at the station.
  // 0.5s is enough.
