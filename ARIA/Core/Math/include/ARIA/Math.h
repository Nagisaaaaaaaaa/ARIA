...
static ARIA_CONST /*constexpr*/ T infinity = std::numeric_limits<T>::infinity();
...
template <typename T>
static ARIA_CONST /*constexpr*/ T maximum = std::numeric_limits<T>::max();
...
template <typename T>
static ARIA_CONST /*constexpr*/ T minimum = std::numeric_limits<T>::min();
...
template <typename T>
static ARIA_CONST /*constexpr*/ T supremum = std::integral<T> ? maximum<T> : std::numeric_limits<T>::infinity();
...
template <typename T>
static ARIA_CONST /*constexpr*/ T infimum = std::integral<T> ? minimum<T> : -std::numeric_limits<T>::infinity();
