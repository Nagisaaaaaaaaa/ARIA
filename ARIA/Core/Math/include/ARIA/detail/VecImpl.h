...
#define __ARIA_PROP_AND_SUB_PROP_INCOMPLETE_PREFAB_MEMBERS_VEC __ARIA_PROP_AND_SUB_PROP_INCOMPLETE_PREFAB_MEMBERS_MAT
...
//
//
#define __ARIA_PROP_INCOMPLETE_PREFAB_VEC(accessGet, accessSet, specifiers, type, /*propName,*/...)                    \
  ...
  __ARIA_PROP_AND_SUB_PROP_INCOMPLETE_PREFAB_MEMBERS_VEC(specifiers, type);                                            \
  ARIA_PROP_END

#define __ARIA_SUB_PROP_INCOMPLETE_PREFAB_VEC(specifiers, type, /*propName,*/...)                                      \
  static_assert(ARIA::vec::detail::is_vec_v<std::decay_t<type>>,                                                       \
                "Type of the property should be `class Vec` in order to use this prefab");                             \
                                                                                                                       \
