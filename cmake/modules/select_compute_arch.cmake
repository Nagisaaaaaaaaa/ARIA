# Modified from: https://github.com/pytorch/pytorch/blob/main/cmake/Modules_CUDA_fix/upstream/FindCUDA/select_compute_arch.cmake
# Synopsis:
...
function(CUDA_SELECT_NVCC_ARCH_FLAGS out_variable)
  ...
  foreach(arch ${cuda_arch_bin})
    if(arch MATCHES "([0-9]+)\\(([0-9]+)\\)")
      ...
      list(APPEND nvcc_archs ${CMAKE_MATCH_1})
  ...
  set(${out_variable}_archs    ${nvcc_archs}          PARENT_SCOPE)
